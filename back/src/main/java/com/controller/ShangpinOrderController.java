           ...
           //取值
            ...
            if(shangpinOrderPaymentTypes == 1){//余额支付
                ...
                if(yonghuEntity.getNewMoney() - money <0 ){
                    ...
                    jifenjiluEntity.setJifenjiluName("购买 "+ shangpinEntity.getShangpinName() + " " + buyNumber + " 个 花费金额 " + money + " 获得积分"+buyJifen);
                ...
                if(yonghuEntity.getYonghuNewJifen() - money <0 ){
                    ...
                    jifenjiluEntity.setJifenjiluName("消费 "+ shangpinEntity.getShangpinName()+" "+buyNumber+" 个 花费积分 "+money);
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        JifenjiluEntity jifenjiluEntity = new JifenjiluEntity();
            ...
            if(shangpinOrderPaymentTypes == 1){//余额支付
                 ...
                 * 修改代码 start
                 */
                Double money = shangpinOrder.getShangpinOrderTruePrice();
                ...
                jifenjiluEntity.setInsertTime(new Date());
                jifenjiluEntity.setJifenTypes(1);
                jifenjiluEntity.setJifenjiluName("退款已购买的"+ shangpinEntity.getShangpinName()+" "+buyNumber+" 个 增加的 "+buyJifen +" 积分");
                jifenjiluEntity.setJifenjiluNumber(money);
            }
            else{//积分支付
                ...
                yonghuEntity.setYonghuNewJifen(yonghuEntity.getYonghuNewJifen() + money); //设置现积分
                    ...
                    jifenjiluEntity.setInsertTime(new Date());
                    jifenjiluEntity.setJifenTypes(2);
                    jifenjiluEntity.setJifenjiluName("退还购买商品所消费的 "+ shangpinEntity.getShangpinName()+" "+buyNumber+" 个 花费积分 "+money);
                    jifenjiluEntity.setJifenjiluNumber(money);
            }
